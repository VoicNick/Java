...
public class Customer {
	...
	private Map<Long, Motorcycle> motorcycles = new HashMap<>();
	...
	public static class Builder {
		...
		/**
		 * @param motorcycles
		 *            the motorcycles to set
		 */
		public void setMotorcycles(Map<Long, Motorcycle> motorcycles) {
	...
	private Customer(Builder builder) {
		...
		motorcycles = builder.motorcycles;
	}
	 ...
	 */
	public Map<Long, Motorcycle> getMotorcycles() {
		return motorcycles;
	}
